...
![FEM-Solver Visualization](https://i.imgur.com/8E89D7A.png)
...
This project is not currently licensed. Please add a `LICENSE` file to the root of the repository to specify the terms under which it can be used, modified, and distributed. The **MIT License** is a popular and permissive choice for academic and open-source projects.
